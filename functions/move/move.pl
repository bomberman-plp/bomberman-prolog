...
/*
  Módulo responsável por calcular a próxima posição (movimentação) e validar colisão:
...
/*Se a posição é Parede, Madeira ou tecla inválida: recusa o movimento*/
